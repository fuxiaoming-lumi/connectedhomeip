...
private:
    friend OnOffLightManager & OnOffLightMgr(void);
    State_t mState;
    ...
    static OnOffLightManager sLight;
};

inline OnOffLightManager & OnOffLightMgr(void)
{
    return OnOffLightManager::sLight;
}
